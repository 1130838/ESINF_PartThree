...
public class FinishedActivityTest {
    ...
    public void setUp() throws Exception {
        ...
        a1 = new FinishedActivity("P1", "A1", "tretas", 14, 2);
        a2 = new FinishedActivity("P2", "A1", "tretas", 14, 2);
        a3 = new FinishedActivity("P1", "A2", "tretas", 14, 2);
        a4 = new FinishedActivity("P1", "A1", "tretas", 14, 1);
        a5 = new FinishedActivity("P2", "A1", "tretas", 14, 1);
    }
